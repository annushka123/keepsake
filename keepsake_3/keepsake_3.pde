...
boolean forceClearBackground = false;
...
void draw() {
    ...
    //    background(0);
    //    println("Forcing a background clear frame.");
    //    forceClearBackground = false; // Reset the flag after clearing
    //    return; // Skip drawing anything else this frame
    //}
...
if (currentState == 2) {
    ...
    if(currentImage == 3 || currentImage == 7 || currentImage == 11) {
    ...
    if(currentImage == 5 || currentImage == 9) {
